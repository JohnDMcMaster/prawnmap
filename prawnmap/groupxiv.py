...
# Absolute so that maps generated by a stand alone install still find the
# viewer. Anyone serving the assets themselves should override this, ideally
# with a site relative URL like "/lib/groupXIV/stable" so the output isn't
# tied to a single domain name.
DEFAULT_URL_BASE = "https://siliconprawn.org/lib/groupXIV/stable"
...
class GroupXIV:
    ...
    def __init__(self, source, copyright_=None, url_base=None):
        self.source = source
    ...
    def gen_js(self):
        ...
        write_js_meta('%s/index.html' % self.out_dir,
                      meta=meta,
